...
python ../../main.py -i img_a.png img_b.png -s img_sec.png -o img_res_a.png img_res_b.png
...
#   python ../../main -i img_a.png img_b.png -l test.pickle -o img_res_a.png img_res_b.png
# ```
# The first step world take significantly longer than the second.
# Or you can combine the 2 step, that is allowed:
# ```
#   python ../../main.py -i img_a.png img_b.png -s img_sec.png \
